...
7. Click the Pi x IDE icon in the New UI main toolbar, or run **Tools | Pi x IDE: Open Pi Terminal**. The embedded terminal should start in the project directory and execute `pi`.
